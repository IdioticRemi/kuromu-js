...
module.exports = class extends Command {
	...
	async run(message) {
		...
		if (this.client.shard) {
			const results = await this.client.shard.broadcastEval(`[this.guilds.reduce((a, g) => a + g.memberCount, 0), this.guilds.size, this.channels.size, (process.memoryUsage().heapUsed / 1024 / 1024)]`);
