...
module.exports = class extends Command {
    ...
    async run(message) {
        ...
        if (message.guild['player'].paused) return await message.sendLocale('COMMAND_PAUSE_ALREADY-PAUSED');

        await message.guild['player'].pause();

        return await message.sendLocale('COMMAND_PAUSE');
    }
